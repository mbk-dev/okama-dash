...
class TestSubmitShowsChart:
    def test_portfolio_submit_shows_chart(self, page, dash_server_url):
        page.goto(
        ...
        assert page.locator("#pf-wealth-indexes svg.main-svg").count() > 0
    ...
    def test_compare_submit_shows_chart(self, page, dash_server_url):
        page.goto(
        ...
        assert page.locator("#al-wealth-indexes svg.main-svg").count() > 0

    def test_benchmark_submit_shows_chart(self, page, dash_server_url):
        page.goto(
        ...
        assert page.locator("#benchmark-graph svg.main-svg").count() > 0
